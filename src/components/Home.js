...
function Home() {
  ...
  return (
    <>
      ...
      <h2 className='home-page'>You are on SterlingB's Love corner home page</h2>
      <h3>To get access to a ticket for second edition of love corner's workshop</h3>
      <h4>Enter a username to gave access to a log in form to reserve a spot for the workshop</h4>
      <input
        ref={myuseref}
        type='text'
